...
<body>
    <div class="invoice-container">
        ...
        <div class="details">
            <p><span class="label">Order Number:</span> {{ $clothingorder->id }}</p>
            <p><span class="label">Customer Name:</span> {{ $clothingorder->customer->name }}</p>
            <p><span class="label">Order Date:</span> {{ $clothingorder->day }}</p>
        </div>
        <table class="invoice-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{ $clothingorder->count * $clothingorder->product->price }}</td>
                </tr>
            </tbody>
        </table>
        <div class="summary">
            <p><strong>Subtotal:</strong> {{ $clothingorder->count * $clothingorder->product->price }} USD</p>
            <p><strong>Tax (Included):</strong> 0 USD</p>
            <p><strong>Discount:</strong> 0 USD</p>
            <p><strong>Total Amount:</strong> {{ $clothingorder->count * $clothingorder->product->price }} USD</p>
        </div>
        <div class="notes">
        ...
        <div class="footer">
            ...
            <p>Expected Delivery Date: {{ $clothingorder->day }}</p>
