        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="product-details mt-4">
                    ...
                    <a href="{{ route('section_product_view' , $basket->product->section->id) }}" class="btn btn-primary">عودة الي صفحة جميع العروض</a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="product-form">
                    <h2>طلب اوردر</h2>
                    <form action="{{ route('send_order', $basket->product->id) }}" method="POST" id="payment-form">
                        @csrf
