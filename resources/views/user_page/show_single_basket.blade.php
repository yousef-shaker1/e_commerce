            ...
            <tr>
                <td>
                  <a href='{{ Storage::url($product->img) }}'>
                      <img src="{{ Storage::url($product->img) }}" alt="صورة المنتج" class="product-img" style="width: 100px; height:100px auto;">
                  </a> 
               </td>
              <td>{{ $product->name }}</td>
...
<script>
    ...
    function updateTotal() {
        ...
        const price = parseFloat("{{ $product->price }}"); // تحويل السعر إلى رقم عائم
