...
//basket
Route::get('/show_basket', [BasketController::class, 'show_basket'])->name('show_basket')->middleware('auth');
Route::get('/add_basket/{id}', [BasketController::class, 'add_basket'])->name('add_basket');
Route::get('/show_single_basket/{id}', [BasketController::class, 'show_single_basket'])->name('show_single_basket');
Route::delete('/del_clothing_basket/{id}', [BasketController::class, 'del_clothing_basket'])->name('del_clothing_basket');
Route::delete('/del_product_basket/{id}', [BasketController::class, 'del_product_basket'])->name('del_product_basket');
...
Route::get('/dashboard', [UserpageController::class, 'dashboard'])->middleware(['auth', 'verified','Is_admin'])->name('dashboard');
    ...
    Route::get('/clothing_order', [ClothingOrderController::class, 'index'])->name('clothing_order');
    Route::get('/clothing_order_status1/{id}', [ClothingOrderController::class, 'status1'])->name('clothing_order.status1');
    Route::get('/clothing_order_status2/{id}', [ClothingOrderController::class, 'status2'])->name('clothing_order.status2');
    Route::get('/clothing_order_status3/{id}', [ClothingOrderController::class, 'status3'])->name('clothing_order.status3');
    Route::delete('/delete_order/{id}', [ClothingOrderController::class, 'destory'])->name('clothing_order');
    Route::delete('delete_order/{id}', [ClothingOrderController::class, 'destory'])->name('delete_clothingorder');
